...
const RESEND_FROM_EMAIL = process.env.NEXT_PUBLIC_RESEND_FROM_EMAIL || 'info@lijustore.co.ke';
        ...
        <div className="mt-6 rounded-xl bg-gray-50 p-4">
          ...
          {items.length > 0 ? (
            ...
            <div className="rounded-lg bg-white p-4 text-sm font-semibold text-gray-500">
              Your cart is empty. <Link href="/products" className="text-brand">Add products</Link> before sending an order email.
            </div>
          )}
        </div>

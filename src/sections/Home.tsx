...
const CATEGORY_ICONS: Record<string, React.ElementType> = {
  ...
  'Electronics': Laptop,
  'Electronics & Entertainment': Laptop,
  'Fitness Equipment': Dumbbell,
  'Fitness, Outdoor & Kids': Dumbbell,
  'Furniture': Armchair,
  'Furniture & Home Essentials': Armchair,
  'Home & Living': HomeIcon,
  'Home Appliances': Plug,
  'Home Appliances Kenya': Plug,
  'Home Office Equipment': HomeIcon,
  'Kids & Baby': Baby,
  'Kitchen Appliances': ChefHat,
  'Kitchen & Commercial Equipment': ChefHat,
  'Lighting': Lightbulb,
  'Networking & Communication': Wifi,
  'Security & Safety Equipment': Camera,
  'Security Cameras & Surveillance Systems': Camera,
  'Solar & Power Backup': Sun,
  'Tools, Electrical & Automotive': Car,
...
const SLIDES = [
  {
    ...
    headline: ['Up to 50% Off', 'Entertainment'],
    headlineAccent: 1,
    body: 'Shop the biggest deals on headphones, smartwatches, TVs and more.',
    cta: { label: 'Shop Electronics', category: 'Electronics & Entertainment' },
  ...
  },
  {
    ...
    cta: { label: 'Shop Appliances', category: 'Home Appliances Kenya' },
  ...
  },
  {
    ...
    headline: ['Tools &', 'Automotive'],
    headlineAccent: 1,
    body: 'From car care to tech upgrades — everything for your ride.',
    cta: { label: 'Shop Automotive', category: 'Tools, Electrical & Automotive' },
                ...
                <div className="max-w-7xl mx-auto px-4 items-center relative z-10">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3">
                      <button
                        onClick={() => { setSelectedCategory(slide.cta.category); router.push('/products'); }}
      ...
      <section className="py-14">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-7">
            ...
            <Link href="/products" className="flex items-center gap-1 text-brand font-semibold text-sm hover:gap-2 transition-all no-underline">

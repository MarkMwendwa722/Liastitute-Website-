  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <Link href="/products" className="text-brand font-semibold no-underline hover:underline">
          ← Back to products
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-7 pb-16">
      ...
      <div className="flex items-center gap-2 text-sm text-gray-500 mb-7 flex-wrap">
        ...
        <Link href="/products" className="text-gray-500 hover:text-brand no-underline">Products</Link>
        <span className="text-gray-300">›</span>
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-16">
        ...
        <div className="flex flex-col gap-5">
          ...
          {inCart && !addedMsg && (
            <Link href="/cart" className="text-brand font-semibold text-sm no-underline hover:underline">
              View in Cart →
            </Link>
          )}

...
export const PRODUCTS = [
  ...
  { id: 78, name: 'Hisense 10.5kg Front Load Washing Machine', price: 53000.0, originalPrice: null, category: 'Home Appliances', rating: 4.5, reviews: 0, image: '/Photos/Hisense 10.5kgs wash and spin front load machine.jpeg', description: 'Hisense 10.5kg front load washing machine with steam technology that removes 99.9% of bacteria. Features ConnectLife smart connectivity for convenient laundry care.', stock: 10, badge: 'New' },
];

      ...
      <div className="max-w-7xl mx-auto px-4 py-14 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex gap-2">
            <a
              href="https://www.instagram.com/liastuteenterprises?igsh=bWhlemZvcWs4YnFk"
              target="_blank"
            ...
            <a
              href="https://vt.tiktok.com/ZSX8mrWWL/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-gray-400 hover:bg-brand hover:text-white transition-colors"
              aria-label="TikTok"
            ...
            <a
              href="https://www.facebook.com/share/1DtNKCRbyk/"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-gray-400 hover:bg-brand hover:text-white transition-colors"
              aria-label="Facebook"
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm mb-5">
            {[
              { Icon: MapPin, text: 'Gaberone plaza, third floor shop T3L Nairobi, Kenya' },
